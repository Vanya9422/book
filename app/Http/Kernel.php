...
class Kernel extends HttpKernel
{
	...
	protected $middlewareGroups = [
		'web' => [
			...
			\App\Http\Middleware\NotFoundIfStaticFileDetected::class,
		...
		'api' => [
			// 'throttle:60,1',
			'bindings',
			\App\Http\Middleware\SwitchGuardToApi::class,
		],
	];
	...
	protected $routeMiddleware = [
		...
		'logged_in_only' => \App\Http\Middleware\LoggedInOnly::class,
		'check_entry_point_route' => \App\Http\Middleware\CheckEntryPointRoute::class,
	];
