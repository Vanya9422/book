 ...
 * Generated for Laravel 6.14.0 on 2020-02-10 08:37:12.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Auth {
        ...
        {
                        /** @var \App\Auth\SessionGuard $instance */
         ...
         * @static 
         */ 
        public static function getEmailType($email)
        {
                        /** @var \App\Auth\SessionGuard $instance */
                        return $instance->getEmailType($email);
        }
        ...
        {
            //Method inherited from \Illuminate\Auth\SessionGuard            
                        \App\Auth\SessionGuard::macro($name, $macro);
        }
        ...
        {
            //Method inherited from \Illuminate\Auth\SessionGuard            
                        \App\Auth\SessionGuard::mixin($mixin, $replace);
        }
        ...
        {
            //Method inherited from \Illuminate\Auth\SessionGuard            
                        return \App\Auth\SessionGuard::hasMacro($name);
        }
    ...
    class Request {
         ...
         * @static 
         */ 
        public static function internal($method, $path, $params = [])
        {
                        return \Illuminate\Http\Request::internal($method, $path, $params);
        }
    ...
    class Response {
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::error($error, $status, $extra);
        }
         ...
         * @static 
         */ 
        public static function resource($resource = null, $extra = [])
        {
                        return \Illuminate\Routing\ResponseFactory::resource($resource, $extra);
        }
    ...
    class Route {
         ...
         * @static 
         */ 
        public static function jumpToRoute($routeName)
        {
                        return \Illuminate\Routing\Router::jumpToRoute($routeName);
        }
