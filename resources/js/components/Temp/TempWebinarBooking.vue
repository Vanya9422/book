							...
							<div class="d-flex py-3 align-items-center bg-white sticky-top">
								<div class="col-3 pl-0 rounded-circle position-relative" style="font-size: 0px;">
									...
									<div class="p-2 rounded-circle bg-success position-absolute border border-white"
										style="border-width: 3px !important; box-sizing: border-box; top: 74%; right: 74%;">
									</div>
								</div>
							...
							<div class="row py-3">
								<div class="col-12">
									<div
										...
										<strong class="d-block text-left"
											style="line-height: 1;">Monday, October 13th, 2020 </strong>
										<div class="row align-items-center">
											<div class="col text-left d-flex align-items-center">
												<img src="/img/confirm_primary.svg" alt="" width="20">
												<div class="ml-3">
													<span class="d-block mt-2">At 15:30 GMT</span>
													<span class="d-block text-dark"><strong>3/10</strong> Seats Remaining</span>
													<span class="d-block text-success mt-2"><strong>30%</strong> Discount</span>
													<span class="d-block text-success"><strong>3d 12h 20m 45s</strong> Left</span>
												</div>
											</div>
											<div class="row pr-3 m-0 flex-column align-items-end">
												<span class="h5 mb-0 d-flex align-items-center">
													<strong class="mr-1">$55</strong>
													<div class="dropdown mr-2">
														...
														<div class="dropdown-menu border-0 shadow py-0" style="min-width: 220px;"
															aria-labelledby="dropdownMenuLink">
															<div
																class="d-flex justify-content-between align-items-center p-3 border-bottom">
																<strong>Ticket Price</strong>
																<a class="btn btn-link p-1" href="#"
																	style="opacity: .3; font-size: 0;">
																	<img src="/img/close.svg" alt="" width="10">
																</a>
															</div>
															<div
									...
									<div
										class="p-3 rounded btn btn-outline-booking btn-block text-decoration-none mb-2">
										<div class="row align-items-center">
											<div class="col text-left">
												<strong class="d-block">Monday, October 13th, 2020 </strong>
												<span class="d-block">At 15:30 GMT</span>
											</div>
											<div class="row pr-3 m-0 flex-column align-items-end">
												<span class="h5 mb-0 d-flex align-items-center">
														...
														<div class="dropdown-menu border-0 shadow p-3"
															...
															<div
																...
																<a class="text-decoration-none text-dark h4 mb-0" href="#"
																	style="opacity: .3; line-height: 0;">×</a>
															</div>
															<div
									...
									<a class="p-3 rounded btn btn-outline-booking btn-block text-decoration-none mb-2"
										href="#">
										<div class="row align-items-center">
											<div class="col text-left">
												<strong class="d-block">Monday, October 13th, 2020 </strong>
									...
									<a class="p-3 rounded btn btn-outline-booking btn-block text-decoration-none"
										href="#">
										<div class="row align-items-center">
											<div class="col text-left">
												<strong class="d-block">Monday, October 13th, 2020 </strong>
					...
					<div class="col-6 position-relative" style="padding-left: 50px;">
						<div class="sticky-top pt-3">
							<div class="d-flex justify-content-end align-items-center mb-5">
								...
								<router-link class="ml-1 btn btn-link p-1" :to="{ name: 'main.home' }">
							...
							<div class="d-flex align-items-center justify-content-between">
								...
								<div id="coupon_code_collapse_button" class="multi-collapse collapse show" style="">
									<button type="button" data-toggle="collapse" data-target=".multi-collapse"
										...
										<span style="font-size: 0;">
											<img src="/img/coupon.svg" width="20" style="opacity: .3;" alt="">
										</span>
										<span class="ml-2">
											Coupon Code
										</span>
							...
							<div id="coupon_code_collapse" class="pt-3 multi-collapse collapse" style="">
							...
							<div class="pb-3 pt-4" style="bottom: 0; right: 0; left: 0;">
								<router-link class="btn btn-block btn-primary py-3 next-step"
									:to="{ name: 'temp.webinar_confirmation' }">
