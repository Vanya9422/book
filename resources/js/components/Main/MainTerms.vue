			...
			<div class="row justify-content-center" style="padding-bottom: 70px;">
				<div class="col-lg-9">
					<div class="sub-section narrow">
						...
						<p>
							Thanks for using Bookify. These Terms of Use (“Terms”) are a legal agreement between you and Bookify, LLC (“Bookify”) and govern your use of all the text, data, information, software, graphics, photographs and more that we and our affiliates may make available to you (all of which we refer to as “Materials”), including our websites and any services, plug-ins, software or other Downloadable Tools (as defined below) that we may provide through any of our websites (the “Platform” and together with the Materials, this “Website”). The terms "us" or "we" or "our" refer to Bookify, the owner of this Website. If you are entering into these Terms on behalf of a company or other organization, you hereby represent and warrant that you are authorized to enter into this Terms on behalf of such company or other organization.
						</p>
						<p>
							READ THESE TERMS CAREFULLY BEFORE BROWSING THIS WEBSITE. USING THIS WEBSITE INDICATES THAT YOU HAVE BOTH READ AND ACCEPT THESE TERMS. YOU CANNOT USE THIS WEBSITE IF YOU DO NOT ACCEPT THESE TERMS. THESE TERMS CONTAIN A DISPUTE RESOLUTION AND ARBITRATION PROVISION, INCLUDING A CLASS ACTION WAIVER THAT AFFECTS YOUR RIGHTS UNDER THESE TERMS AND WITH RESPECT TO DISPUTES YOU MAY HAVE WITH BOOKIFY. YOU MAY OPT OUT OF THE BINDING INDIVIDUAL ARBITRATION AND CLASS ACTION WAIVER AS PROVIDED BELOW.
						</p>
						<p>
							<strong>
								IF YOU ARE A USER LOCATED IN THE EUROPEAN ECONOMIC AREA, SWITZERLAND OR UNITED KINGDOM, THE <a href="/pages/dpa">DATA PROCESSING ADDENDUM</a> ACCOMPANIES THESE TERMS AND SETS FORTH OTHER TERMS OF OUR AGREEMENT THAT APPLY SOLELY TO THE EXTENT ANY INFORMATION YOU PROVIDE TO BOOKIFY INCLUDES PERSONAL DATA OF INDIVIDUALS LOCATED IN THE EUROPEAN ECONOMIC AREA, SWITZERLAND AND THE UNITED KINGDOM.
							</strong>
						</p>
						<h3 class="ptl pbs">
							SCOPE
						...
						<p>
							Bookify’s Platform facilitates online scheduling of appointments. You may access and use the Platform in accordance with these Terms. Please note that these Terms govern your use of the Platform, including, but not limited to, the process through which your users schedule appointments with you.
						</p>
						<p>
							When using the features of the Platform you are subject to any agreements, policies or guidelines applicable to such features that may be posted from time to time. All such agreements, policies or guidelines, including the <a href="/pages/privacy">Privacy Policy</a>, the <a href="/pages/eula">End User License Agreement</a> and the Data Processing Addendum (as applicable) are hereby incorporated by reference into these Terms.
						</p>
						<h3 class="ptl pbs">
							GENERAL USE
						</h3>
						...
						<p>
							Our Website is not intended for and may not be used by individuals under 13 years of age. By registering for a Bookify account, you promise that you are at least 18 years of age.
						</p>
						<h3 class="ptl pbs">
							ACCOUNT SETUP
						</h3>
						<p>
							To use the Platform, you need to set up a Bookify account. You may establish either a free account (“Free Account”) or a paid account (“Paid Account”). You are authorized by Bookify to set up one Free Account only. Bookify reserves the right to terminate any additional Free Accounts set up by you and any Free Accounts that have been inactive over 6 months.
						</p>
						<p>
						...
						<p>
							Bookify or our billing processors collect your billing information when you upgrade to a Paid Account. All of this registration information is protected in accordance with our <a href="/pages/privacy">Privacy Policy</a>.
						</p>
						<h3 class="ptl pbs">
							SUBSCRIPTION PERIOD AND SUBSCRIPTION FEES
						</h3>
						<p>
							You agree to pay all applicable fees related to your use of this Website and the Platform which are described fully <a href="/pages/pricing">on our pricing page</a>. By providing a payment method, you expressly authorize us to charge the applicable fees on said payment method as well as taxes and other charges incurred thereto at regular intervals, all of which depend on your particular membership and utilized services.
						</p>
						<p>
							The subscription period for Paid Accounts can be month-to-month, yearly, or another duration described more fully <a href="/pages/pricing">on our pricing page</a>. For Free Accounts, the subscription period is month-to-month unless earlier terminated as provided in these Terms.
						</p>
						<p>
							Paid Accounts are subject to fees based upon the account type you've selected. For renewals, Bookify will automatically charge your credit card the amount of the then-current fee for your type of account, plus applicable taxes. All payments are non-refundable. To the extent that payment mechanisms are provided through third parties, you agree that Bookify will have no liability to you arising out of the acts or omissions of such third parties.
						</p>
						<p>
							BY CREATING A PAID ACCOUNT, YOU CONSENT TO ALLOW BOOKIFY TO CHARGE YOUR CREDIT CARD, EITHER DIRECTLY OR THROUGH ITS PAYMENT PROCESSORS, FOR THE AMOUNTS DUE FOR YOUR INITIAL SUBSCRIPTION PERIOD AND FOR ADDITIONAL SUBSCRIPTION PERIODS UNTIL YOUR ACCOUNT IS CANCELED OR TERMINATED. PLEASE PRINT OUT THESE TERMS AND CONDITIONS FOR YOUR RECORDS.
						</p>
						<h3 class="ptl pbs">
							RENEWAL/CANCELLATION
						</h3>
						<p>
							Paid Accounts will automatically renew for the same Subscription Period unless you cancel the account by the end of the then-current Subscription Period. You can cancel your account at any time by contacting customer service at support@bookify.ai. Cancellation will be effective immediately. Please note that after you cancel your account, you will not be able to use or access the Platform and you will not be entitled to a refund of any fees that you've paid.
						</p>
						<h3 class="ptl pbs">
							LEGAL COMPLIANCE
						</h3>
						<p>
							You agree to comply with all applicable domestic and international laws, statutes, ordinances, and regulations regarding your use of our Website. Bookify reserves the right to investigate complaints or reported violations of our Terms and to take any action we deem appropriate, including but not limited to canceling your Member account, reporting any suspected unlawful activity to law enforcement officials, regulators, or other third parties and disclosing any information necessary or appropriate to such persons or entities relating to your profile, e-mail addresses, usage history, posted materials, IP addresses and traffic information, as allowed under our <a href="/pages/privacy">Privacy Policy</a>.
						</p>
						<h3 class="ptl pbs">
						...
						<p>
							Our Website may contain links to third party websites. These links are provided solely as a convenience to you. By linking to these websites, we do not create or have an affiliation with, or sponsor such third party websites. The inclusion of links within our Website does not constitute any endorsement, guarantee, warranty, or recommendation of such third party websites. Bookify has no control over the legal documents and privacy practices of third party websites; as such, you access any such third party websites at your own risk.
						</p>
						<h3 class="ptl pbs">
							FORUMS
						</h3>
						<p>
							Certain areas of this Website are public-facing and allow you to interact with others (e.g., the Bookify blog and the idea portal) (together, “Forums”). These Forums may permit you to submit feedback, information, data, text, software, messages, or other materials (each, a "Submission"). We love hearing from our users! It's incredibly helpful and helps us to make a better Bookify for all. If you choose to submit ideas, comments, or feedback, either directly to us or via a Forum, you agree that we can use them without any restrictions or compensation to you.
						</p>
						<p>
							You agree that you are solely responsible for all of your Submissions and that any such Submissions are considered both non-confidential and non-proprietary. If you use Forums, you also understand that anyone could see your Submissions. Bookify does not endorse, nor are we required to pre-screen your Submissions (although we might), and, like elsewhere on the Internet, Submissions from other people could offend you. Further, we do not guarantee that you will be able to edit or delete any Submission you have submitted.
						</p>
						<p>
						...
						<p>
							You alone are responsible for any violation of these Terms by you. You agree to indemnify and hold Bookify, its parents, subsidiaries, affiliates, officers, agents, employees, resellers or other partners and licensors harmless from any claim, demand, loss, or damages, including reasonable attorneys’ fees, arising out of or related to your Data, or the use thereof, including but not limited to allegations that any processing of your Data by Bookify and/or you under this Agreement violates any applicable law or regulation, or infringes the privacy or intellectual property rights of a third party, your User Content, your use of the Bookify Properties, your violation of these terms, or your violation of any law.
						</p>
						<h3 class="ptl pbs">
						...
						<p>
							BOOKIFY WILL NOT BE LIABLE TO YOU FOR ANY DAMAGES RESULTING FROM YOUR USE OF THE WEBSITE OR YOUR DISPLAYING, COPYING, OR DOWNLOADING ANY MATERIALS TO OR FROM THE WEBSITE. IN NO EVENT WILL BOOKIFY BE LIABLE TO YOU FOR ANY INDIRECT, EXTRAORDINARY, EXEMPLARY, PUNITIVE, SPECIAL, INCIDENTAL, OR CONSEQUENTIAL DAMAGES (INCLUDING LOSS OF DATA, REVENUE, PROFITS, USE OR OTHER ECONOMIC ADVANTAGE) HOWEVER ARISING, EVEN IF WE KNOW THERE IS A POSSIBILITY OF SUCH DAMAGE.
						</p>
						<p>
							BOOKIFY’S MAXIMUM AGGREGATE LIABILITY TO YOU IN CONNECTION WITH THESE TERMS OR THE WEBSITE, REGARDLESS OF THE FORM OF ACTION (WHETHER SUCH LIABILITY ARISES DUE TO NEGLIGENCE, BREACH OF CONTRACT, MISREPRESENTATION OR FOR ANY OTHER REASON), WILL AT ALL TIMES BE LIMITED TO THE GREATER OF (I) THE AMOUNT PAID, IF ANY, BY YOU TO BOOKIFY IN CONNECTION WITH THESE TERMS IN THE TWELVE (12) MONTHS PRIOR TO THE ACTION GIVING RISE TO LIABILITY OR (II) US $100.00.
						</p>
						<h3 class="ptl pbs">
						...
						<p>
							<strong>Please Read This Provision Carefully. It Affects Your Legal Rights.</strong>
						</p>
						<p>
						...
						<p>
							...
							<em>Les parties déclarent par les présentes qu’elles exigent que cette entente et tous les documents y afferents, soit pour le present ou le future, soient rédigés en langue anglaise seulement.</em>
						</p>
						<h3 class="ptl pbs">
							CONTACT US
						</h3>
						<p>
							If you have any questions about these Terms or otherwise need to contact us for any reason, you can reach us at <a href="mailto:support@bookify.ai">support@bookify.ai</a> or 1315 Peachtree St NE Atlanta, GA 30309.
						</p>
					</div>
				</div>
			</div>
