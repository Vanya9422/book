<template>
	<div>
		<div class="container p-4">
			<h2 class="text-center mb-4" style="padding-top: 100px;">
				Privacy Policy
			</h2>
			<div class="row justify-content-center" style="padding-bottom: 70px;">
				<div class="col-lg-9">
					<div class="sub-section narrow">
						...
						<p>
							Bookify LLC (“Bookify”, “we”, or “us”) recognizes the importance of privacy. We want you to feel confident using our services, and this privacy policy (“Policy”) is to help you understand and describe how we collect, use, and disclose information that we obtain about users of our websites, services, plug-ins, software or other Downloadable Tools (all of which we refer to as the “Platform”). This Policy describes the following:
						</p>
						<ul class="bulleted mbm">
							<li>
						...
						<p>
							Throughout this document, we will use a few terms to describe various roles. Bookify Members have signed up to use our service and created an account. Bookify Users are people who are scheduling with a Bookify Member and have not registered and created an account with us.
						</p>
						<h3 class="document-header">
							<a id="information-we-collect" aria-hidden="" class="anchor"></a>
							Information We Collect
							<a class="header-link" href="#information-we-collect">
								<i class="icon-link"></i>
							</a>
						</h3>
						<p>
						...
						<p>
							Bookify is not directed to children under thirteen (13) years of age and we do not knowingly collect personal information from children under 13. If we discover that a child under 13 has provided us with personal information, we will promptly delete such personal information from our systems.
						</p>
						<h3 class="document-header">
							<a
								id="information-you-provide-voluntarily"
								aria-hidden=""
								class="anchor"></a>Information You Provide Voluntarily<a
								class="header-link"
								href="#information-you-provide-voluntarily">
								<i class="icon-link"></i>
							</a>
						</h3>
						<ul class="bulleted">
							<li>
								<p>
									...
									When a Bookify User comes to Bookify to schedule an event with a Bookify Member, you voluntarily give us certain information. This can include your name, email address and phone number; email addresses of other people; subject of the meeting; and any other information you provide us or as required by the Bookify Member you are scheduling with. If you receive an invitation from a Bookify Member but do not wish to become a Bookify User, please contact the Bookify Member who sent the invitation through other means to set up your meeting.
								</p>
								<p>
									A Bookify Member may also connect their calendar with Bookify. Our calendar integration only checks the duration and free/busy status of the events in your calendar so that we don't book you when you're busy. We never store who you're meeting with, their email, the meeting title or any other details about the appointments in your connected calendar.
								</p>
							</li>
							<li>
								<strong>Account Information.</strong>
								Bookify Members may give us permission to access their information in other services. For example, with your consent, you may link your Bookify account with your Google, Microsoft Office 365 account, or other similar service, which allows us to obtain information from those accounts (like your basic profile or contacts). The information we get from those services often depends on your settings or their privacy policies, so be sure to check what those are.
							</li>
							<li>
								<strong>Billing Information.</strong>
								If you purchase a premium version of Bookify, our third-party payment processors will collect and store your billing address and credit card information. We store the last four digits of your credit card number, card type and the expiration date.
							</li>
						</ul>
						<h3 class="document-header">
							<a
								...
								aria-hidden=""
								class="anchor"></a>Information Collected Automatically<a
								class="header-link"
								href="#information-collected-automatically">
								<i class="icon-link"></i>
							</a>
						</h3>
						<p>
						...
						<ul class="bulleted">
							<li>
								...
								When you use Bookify, our servers automatically record information (“log data”), including information that your browser sends whenever you visit our Website. This log data may include your web address you came from or are going to, your device model, operating system, browser type, unique device identifier, IP address, mobile network carrier, and time zone or location. Whether we collect some or all of this information often depends on what type of device you’re using and its settings. For example, different types of information are available depending on whether you’re using a Mac or a PC, or an iPhone or an Android phone. To learn more about what information your device makes available to us, please check the policies of your device manufacturer or software provider.
							</li>
						</ul>
						<h3 class="document-header">
							<a
								id="cookies-and-other-tracking-mechanisms"
								aria-hidden=""
								class="anchor"></a>Cookies and Other Tracking Mechanisms<a
								class="header-link"
								href="#cookies-and-other-tracking-mechanisms">
								<i class="icon-link"></i>
							</a>
						</h3>
						<ul class="bulleted">
							<li>
								...
								Depending on how you’re accessing our products and subject to your opt-out preferences, we may use “cookies” (a small text file sent by your computer each time you visit our website, unique to your Bookify account or your browser) or similar technologies to record log data. When we use cookies, we may use “session” cookies (that last until you close your browser) or “persistent” cookies (that last until you or your browser delete them). For example, we may use cookies to keep you logged in to Bookify. Some of the cookies we use are associated with your Bookify account (including personal information about you, such as the email address you gave us), and other cookies are not. To help us make emails more useful and interesting, we often receive a confirmation when you open email from Bookify if your computer supports such capabilities. You can opt out of receiving emails from us. Please see the Your Rights and Choices section below.
							</li>
							<li>
								<strong>Other Web Site Analytics Services.</strong>
								Subject to your opt-out preferences (see Your Rights and Choices below), we use third party service providers such as Google Analytics to provide certain analytics and user interactions services to Bookify in connection with our operation of our Platform, including the collection and tracking of certain data and information regarding the characteristics and activities of visitors Bookify. You may opt-out of Google Analytics’ and Mixpanel’s cookies using Opt-Out Features on their respective websites.
							</li>
						</ul>
						<h3 class="document-header">
							<a
								...
								aria-hidden=""
								class="anchor"></a>How We Use Your Information<a class="header-link" href="#how-we-use-your-information">
								<i class="icon-link"></i>
							</a>
						</h3>
						<p>
						...
						<ul class="bulleted">
							<li>
								<strong>Provide the Bookify Service.</strong>
							...
							<li>
								<strong>Understand and improve our products.</strong>
							...
							<li>
								...
								Subject to your opt-out preference, we may send you emails about new product features or other news about Bookify or on topics we think would be relevant to you. You may opt out of receiving these communications at any time. Visit the Your Rights and Choices section below. For Bookify users who are not Bookify Members, please be assured that we do not use the email addresses that you enter through email invitations to send any type of direct marketing.
							</li>
							<li>
								<strong>Responding to your requests.</strong>
								We will also use your information to respond to your questions or comments.
							</li>
							<li>
								<strong>Administrative.</strong>
								We may contact you to inform you about changes in our services, our service offering and other important service related notices, such as changes to the Policy or about security or fraud notices.
							</li>
							<li>
								<strong>Advertising.</strong>
								Subject to your opt-out preferences, we may develop and display content and advertising tailored to your interests on our services and other sites. See Your Rights and Choices below.
							</li>
							<li>
								<strong>Protecting Rights and Interests.</strong>
								We will use your information to protect our rights and interests as well as the rights and interests of our users and any other person, as well as to enforce this Policy or our Terms of Service.
							</li>
							<li>
								<strong>Legal Compliance.</strong>
								We may use your information to comply with applicable legal or regulatory obligations, including informal requests from law enforcement or other governmental authorities.
							</li>
							<li>
								<strong>Other.</strong>
						...
						<h3 class="document-header">
							<a
								id="with-whom-we-may-share-your-information"
								aria-hidden=""
								class="anchor"></a>With Whom We May Share Your Information<a
								class="header-link"
								href="#with-whom-we-may-share-your-information">
								<i class="icon-link"></i>
							</a>
						</h3>
						<p>
						...
						<ul class="bulleted">
							<li>
								<strong>With third party service providers, agents, or contractors.</strong>
							...
							<li>
								<strong>Aggregate or De-identified Information.</strong>
						...
						<h3 class="document-header">
							<a
								id="legal-basis-for-processing-your-information"
								aria-hidden=""
								class="anchor"></a>Legal Basis for Processing Your Information<a
								class="header-link"
								href="#legal-basis-for-processing-your-information">
								<i class="icon-link"></i>
							</a>
						</h3>
						<p>
						...
						<ul class="bulleted">
							<li>
								...
								We may use your personal information as described in this Policy subject to your consent. To withdraw your consent, please contact us at support@bookify.ai. You may also refrain from providing, or withdraw, your consent for cookies. Please see Your Rights and Choices below for more information on opt-outs.
							</li>
							<li>
								<strong>Performance of a contract.</strong>
								We may need to collect and use your personal information of Bookify Members and Bookify Users, as applicable, to perform our contractual obligations.
							</li>
							<li>
						...
						<h3 class="document-header">
							<a id="your-rights-and-choices" aria-hidden="" class="anchor"></a>Your Rights and Choices<a
								class="header-link"
						...
						<ul class="bulleted">
							<li>
								...
								In order to keep your personal information accurate and complete, you can log in to review and update your account information, including contact and billing information, via your account settings page. You may also contact us to request information about the personal data we have collected from you and to request the correction, modification or deletion of such personal information. We will do our best to honor your requests subject to any legal and contractual obligations. If you would like to make a request, cancel your account or request we delete or no longer use your account information to provide you Services, contact us at
								<a href="mailto:support@bookify.ai">support@bookify.ai</a> or the address set forth at the end of this Policy. Subject to applicable law, we will retain and use your account information only as necessary to comply with our legal obligations, resolve disputes and enforce our agreements.
							</li>
							<li>
							...
							<li>
								...
								<p>
									The Google Analytics service is provided by Google Inc. You can opt-out from Google Analytics service from using your information by installing the Google Analytics Opt-out Browser tool:
									<a
										target="_blank"
										href="https://tools.google.com/dlpage/gaoptout">tools.google.com/dlpage/gaoptout</a>. For more information on the privacy practices of Google, please visit the Google Privacy &amp; Terms web page:
									<a
										target="_blank"
										href="https://www.google.com/policies/privacy">www.google.com/policies/privacy</a>.
								</p>
								<p>
									Mixpanel is provided by Mixpanel Inc. You can prevent Mixpanel from using your information for analytics purposes by opting out at
									<a
										target="_blank"
										href="https://www.mixpanel.com/optout">www.mixpanel.com/optout</a>. For more information on what type of information Mixpanel collects, please visit the Mixpanel’s Terms of Use page at
									<a target="_blank" href="https://www.mixpanel.com/terms">www.mixpanel.com/terms</a>.
								</p>
							</li>
							<li>
						...
						<h3 class="document-header">
							<a
								id="security-and-storage-of-information"
								aria-hidden=""
								class="anchor"></a>Security and Storage of Information<a
								class="header-link"
								href="#security-and-storage-of-information">
								<i class="icon-link"></i>
							</a>
						</h3>
						<p>
						...
						<h3 class="document-header">
							<a
								...
								aria-hidden=""
								class="anchor"></a>Third-Party Links<a class="header-link" href="#third-party-links">
								<i class="icon-link"></i>
							</a>
						</h3>
						<p>
						...
						<h3 class="document-header">
							<a id="users-outside-the-usa" aria-hidden="" class="anchor"></a>Users Outside the USA<a
								class="header-link"
								href="#users-outside-the-usa">
								<i class="icon-link"></i>
							</a>
						</h3>
						<p>
							Our application and database servers are located with Amazon Cloud Services in the United States. Amazon Cloud Services has certified with the Department of Commerce that it adheres to the Privacy Shield Principles under the EU-U.S. and Swiss-U.S. Privacy Shield frameworks. If you are an individual located in the European Economic Area, the United Kingdom, Canada or another jurisdiction outside of the United States with laws and regulations governing personal data collection, use, and disclosure that differ from United States laws, please be aware that information we collect (including through the use of methods such as cookies and other web technologies) will be processed and stored in the United States or in other countries where we or our third-party services providers have operations. By submitting your personal information to Bookify and using Bookify, you expressly consent to having your personal data transferred to, processed, and stored in the United States or another jurisdiction which may not offer the same level of privacy protection as those in the country where you reside or are a citizen.
						</p>
						<h3 class="document-header">
							<a id="california-disclosures" aria-hidden="" class="anchor"></a>California Disclosures<a
								class="header-link"
								href="#california-disclosures">
								<i class="icon-link"></i>
							</a>
						</h3>
						<ul class="bulleted">
							<li>
								<strong>California Information-Sharing Disclosure.</strong>
								California residents may request a list of all third parties with respect to which we have disclosed any information about you for direct marketing purposes and the categories of information disclosed. If you are a California resident and want such a list, please send us a written request by email to
								<a href="mailto:support@bookify.ai">support@bookify.ai</a> with “California Privacy Rights” in the subject line.
							</li>
							<li>
						...
						<h3 class="document-header">
							<a id="changes-to-the-policy" aria-hidden="" class="anchor"></a>Changes to the Policy<a
								class="header-link"
								href="#changes-to-the-policy">
								<i class="icon-link"></i>
							</a>
						</h3>
						<p>
							This Policy is current as of the Effective Date set forth above. We may change this Policy from time to time, and if we do we’ll post any changes, including any material changes, on this page, so please be sure to check back periodically. If you continue to use Bookify after those changes are in effect, you agree to the revised Policy.
						</p>
						<h3 class="document-header">
							<a id="contacting-us" aria-hidden="" class="anchor"></a>Contacting Us<a
								class="header-link"
								href="#contacting-us">
								<i class="icon-link"></i>
							</a>
						...
						<p>
							...
							<a href="mailto:support@bookify.ai">support@bookify.ai</a>
							or 1315 Peachtree St NE, Atlanta, GA 30309.
						</p>
					</div>
				</div>
			</div>
